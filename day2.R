...
X>20 #vector with TRUE/FALSE
(X<= 10)|(X>=30) #vector with TRUE/FALSE
X[X<10|X>30] #values which meet condition
...
###HOMEWORK
setwd("")
mydata <- read.csv("D:/Backup 27.12.2016/Dokumente/Uni/Master/MB2 Introduction to Programming and Geostatistics/2017-11-07/homework_example_data.csv", 
...
order(ages, decreasing = FALSE) #prints index of elements
