...
#' @description Based on the results of \emph{\code{\link[=sensitivity_analysis]{sensitivity analysis}}}. Derives the minimum and maximum
#' threshold meeting one of the following criteria: a) maximum difference of one column from a value or b)
#' minimum value of a column.
#' @param thresholds vector of all possible thresholds
#' @param values vector of values which should meet the criterion
